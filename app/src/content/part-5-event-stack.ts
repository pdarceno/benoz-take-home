import type { EventStackConfig, SectionConfig } from "./types";

export const part5EventStack: EventStackConfig = {
      intro: `
...
export const part5Section: SectionConfig = {
  id: "part-5",
  title: "Event Platform — Stack & Decisions",
  kind: "event-stack",
  eventStack: part5EventStack,
};
